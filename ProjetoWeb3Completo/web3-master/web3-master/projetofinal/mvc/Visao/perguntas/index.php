<div class="center-block site">
    ...
    <div class="margin-bottom">
        <form action="<?= URL_RAIZ . 'perguntas' ?>" method="post" enctype="multipart/form-data">
            <div class="form-group <?= $this->getErroCss('foto_pergunta') ?>">
                <label class="control-label" for="foto_pergunta">Question Picture (PNG file)</label>
                <?php $this->incluirVisao('util/formErro.php', ['campo' => 'foto_pergunta']) ?>
                <input id="foto_pergunta" name="foto_pergunta" class="form-control" type="file">
            </div>
            <br><br>
            ...
            <div class="form-group <?= $this->getErroCss('correta') ?>">
                <label class="control-label" for="dificulty">Correct Answer</label>
                <?php $this->incluirVisao('util/formErro.php', ['campo' => 'correta']) ?>
                <select id="correta" name="correta" class="form-control" autofocus>
                    <?php $selected = $this->getPost('correta')  ? 'selected' : '' ?>
